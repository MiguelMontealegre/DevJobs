...
<body class="mt-20">
  ...
  <span class="margenl font-bold text-3xl text-gray-700">Ubicacion: {{$ubicacion->nombre}} </span>
  <p class="margenl text-purple-500 font-bold">Hay un total de {{count($vacantes)}} Vacantes en esta ubicacion</p>
  ...
  <h5 class="text-transparent">efjewfjnwfkjwe</h5>
    ...
    <div class="card333 md:max-w-xl">
        ...
        <div class="back333 px-3 rounded">
          <h2 class="text-xl text-center mt-10 text-gray-900 font-bold mb-3"> Conocimientos Necesarios: </h2>
          @php
  ...
  @else
  <div class="pt-6 pb-2 px-6 max-w-md mx-auto bg-white rounded-xl shadow-lg flex space-x-4 border mt-3">
    <div class="shrink-0">
      <img class="h-12 w-12" src="https://img.icons8.com/cute-clipart/64/000000/warning-shield.png"/>
    </div>
    <div>
      <div class="text-xl font-medium text-black">Aun no hay vacantes para esta clasificacion</div>
      <p class=" text-red-500">Intenta mas tarde</p>
      <p class=" text-gray-500">Puedes cencontrar mas en nuestros buscadores</p>
    </div>
  </div>
  @endif
