...
<body class="mt-20">
  ...
  <span class="margenl font-bold text-3xl text-gray-700">Experiencia: {{$experiencia->nombre}} </span>
  <p class="margenl text-purple-500 font-bold">Hay un total de {{count($vacantes)}} Vacantes con esta experiencia</p>
          ...
          <div class="">
            ...
            <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
              ...
              <div class="p-6 flex flex-col justify-start">
                ...
                @if(str_word_count($vacante->descripcion) === 1)
                <p class="mt-2.5 text-gray-400"> {{ Str::limit(  strip_tags( $vacante->descripcion), 26, ' ...' ) }} </p>
                @else
