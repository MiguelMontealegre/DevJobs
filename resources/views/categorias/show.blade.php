...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="text-gray-700 navbar-brand" href="#">
            <span class="font-bold text-3xl text-gray-700">Categoría: {{$categoria->nombre}} </span></a>
      </div>
      <button class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation">
        <span class="sr-only">Toggle navigation</span>
        <span class="navbar-toggler-icon icon-bar"></span>
...
<body class="mt-20">
  ...
  <span class="margenl font-bold text-3xl text-gray-700">Categoría: {{$categoria->nombre}} </span>
  <p class="margenl text-purple-500 font-bold">Hay un total de {{count($vacantes)}} Vacantes para esta categoria</p>
