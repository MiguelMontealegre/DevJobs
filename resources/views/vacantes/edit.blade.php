  ...
  <div id="app">
    ...
    <div class="contenedor33 col-lg-6 col-sm-12 rounded inline-block float-left">
      ...
      <p class="text-3xl font-bold text-gray-700 mt-8 ml-10">
        Actualizar Vacante <span class="font-bold text-purple-600">{{$vacante->titulo}}</span>
      </p>
...
@method('PUT')
    ...
    <div class="mb-4">
        ...
        <option value="" disabled selected>-Selecciona-</option>   
           ...
           @foreach($ubicacion as $ubi)   
             <option class="text-purple-500"
             {{$vacante->ubicacion_id == $ubi->id ? 'selected' : ''}}
    ...
    <div class="mb-5">
        ...
        <div class="medium-editor overflow-auto p-3 bg-white text-gray-700 rounded border border-gray-200 form-input w-full" style="max-height: 320px"></div>  <!--La herramienta MEDIUMEDITOR Funciona mediante un *div* por lo cual se haria con esta sintaxis masomenos -->
        <input id="descripcion" type="hidden" name="descripcion" value="{{$vacante->descripcion}}">
...
<!--En el props de esta etiqueta se le ponen 2 puntos cunado es un arreglo u objeto con mas dinamismo, pero en caso contrario , por ejemplo cuando estamos trabajando con un string (moment.js) como fechas u cosas asi , se le quitan esos puntos a el props -->
 ...
 @enderror
    ...
    <button type="submit" class="mx-auto btneon btneon--2 font-bold mt-5"> Actualizar Vacante   
    </button>
    ...
    <div class="contenedor44 rounded inline-block float-left">
      ...
      <div class="fixed bg-white rounded">
        <img class="rounded" width="400" height="300" src="{{asset('material/img/editt.jpg')}}" alt="">
    
        <p class="text-2xl font-bold text-purple-600 mt-2 ml-10">
          Cambia  <span class="font-bold text-sm text-gray-700">cualquier aspecto de tu Vacante</span>
        </p>
