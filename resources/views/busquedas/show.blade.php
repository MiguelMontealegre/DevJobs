...
<body class="mt-20">
  ...
  <span class="margenl font-bold text-3xl text-gray-700">Busqueda: {{$busqueda}} </span>
  <p class="margenl text-purple-500 font-bold">Hay un total de {{count($vacantes)}} Vacantes para esta busqueda</p>
