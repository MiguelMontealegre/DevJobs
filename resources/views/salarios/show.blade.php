...
<body class="mt-20">
  ...
  <span class="margenl font-bold text-3xl text-gray-700">Salario: {{$salario->nombre}} </span>
  <p class="margenl text-purple-500 font-bold">Hay un total de {{count($vacantes)}} Vacantes con este salario</p>
    ...
    <div class="card333 md:max-w-xl">
        ...
        <div class="back333 px-3 rounded">
          ...
          @foreach($arraySkills as $skill)
              <p class="inline-block text-gray-800 font-bold my-2 bordex bordex--2 px-8 py-2">
                   {{$skill}}
              </p>
          @endforeach
