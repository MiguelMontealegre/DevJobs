    ...
    <div class="container">
      <div class="navbar-wrapper">
        <a class="text-gray-700 navbar-brand ml-0" href="#">
            <span class="font-bold text-3xl text-gray-700 ml-0">Notificaciones Nuevas </span></a>
      </div>
...
<a href="{{route('notificacionesAll')}}">  <button class="mt-20 ml-20 px-5 py-2 text-sm text-purple-600 font-semibold rounded-full border border-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2"><span class="material-icons">
  explore
  </span>
  Ver todas las notificaciones</button>  </a>
...
<div class="mt-0 flex flex-col lg:flex-row shadow">
  <div class="lg:w-1/2 px-8 lg:px-12 py-5 lg:py-24">
    ...
    <div class="block lg:w-1/2">
      ...
      <h1 class="ml-20 mt-20 text-2xl text-white font-bold">Nuevos {{count($notificaciones)}} candidatos</h1>
...
@foreach($notificaciones as $key => $notificacion)
   ...
   <div class="border mt-6 mb-10 py-8 px-8 max-w-sm ml-20 rounded-xl shadow-md space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
